...
//+kubebuilder:rbac:groups=externaldns.k8s.io,resources=dnsendpoints,verbs=get;list;create;update;delete
...
func (r *DKIMKeyReconciler) reconcile(ctx context.Context, dk *dkimmanagerv1.DKIMKey) (ctrl.Result, error) {
	...
	return ctrl.Result{}, r.reconcileDKIMPrivateKey(ctx, dk, key)
}
...
func (r *DKIMKeyReconciler) reconcileDKIMRecord(ctx context.Context, dk *dkimmanagerv1.DKIMKey, pub string) error {
	...
	return r.Patch(ctx, de, client.Apply, &client.PatchOptions{
